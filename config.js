...
global.read_status_from =  process.env.READ_STATUS_FROM  ||  "254717646309,923xxxxxxxx";
...
module.exports = {
  ...
  author : process.env.PACK_AUTHER|| "Manu-MD",
  packname: process.env.PACK_NAME || "♥️",
  botname : process.env.BOT_NAME  || "sᴜʜᴀɪʟ-ᴍᴅ",
  ownername:process.env.OWNER_NAME|| "It'x Manu",
